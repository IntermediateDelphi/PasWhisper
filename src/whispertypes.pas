...
type
  ...
  var
    ...
    d_ln_b:     PggmlTensor;
    layers_encoder: Array of PWhisperLayerEncoder;
    layers_decoder: Array of PWhisperLayerDecoder;
    // ggml context that contains all the meta information about the model tensors
    ctx:        PggmlContext;
    // the model backend data is read-only and can be shared between processors
    buffer:     PggmlBackendBuffer;
    // tensors
    n_loaded:   Int32;
